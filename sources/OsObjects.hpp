...
public:
	...
	bool operator==(const COsBoardType& b) const;
...
public:
	...
	bool operator==(const COsBoard& b) const;
...
public:
	...
	COsClock cks[2];
	void Update(const COsMoveListItem& mli);
	void Update(const COsMoveList& ml, unsigned long nMoves=100000);
