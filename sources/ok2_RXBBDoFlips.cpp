 ...
 */
 ...
 // les retournements
 // a l'aide de masks et d'operations binaires calcule direction par direction
 // les retournments d'un coup
...
bool RXBitBoard::do_flips_F4(unsigned long long& discs_player, unsigned long long& discs_opponent) {
	...
	if(r != 0) {
		flipped |= (r - (0X2ULL<<_bsrll(my_discs))) & 0X0000000004040400ULL;
	}
